...
func seedUsers() {
	...
	var Admin user.LocalUser = user.LocalUser{
		...
		Email:     "admin@tutoring.cantusolutions.com",
	...
	var student user.LocalUser = user.LocalUser{
		...
		Email:     "student@tutoring.cantusolutions.com",
		Password:  "P@33word123!",
		IsAdmin:   false,
		Role:      1,
	}
	...
	var supervisor user.LocalUser = user.LocalUser{
		...
		Email:     "supervisor@tutoring.cantusolutions.com",
		Password:  "P@33word123!",
		IsAdmin:   false,
		Role:      3,
	}
	...
	var Tutor2 user.LocalUser = user.LocalUser{
		...
		Email:     "tutor@tutoring.cantusolutions.com",
		Password:  "P@33word123!",
		IsAdmin:   false,
		Role:      2,
	}
