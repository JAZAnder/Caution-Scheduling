      ...
      {isMobile ? (
        ...
        <Container className="mobile-lab-schedule">
          <div className="mobile-lab-content">
            <img src={EnvocLab} alt="Envoc Lab" className="img-fluid mobile-lab-image" />
            <a href="http://meet.google.com/cgc-diaj-gnx" className="d-block mt-2">
              <Button variant="primary">Envoc Google Link</Button>
            </a>
          </div>
          <div className="mobile-lab-content">
            <img src={FayLab} alt="Fay 125 Lab" className="img-fluid mobile-lab-image" />
            <a href="http://meet.google.com/fda-vanx-mnd" className="d-block mt-2">
              <Button variant="primary">Fayard Google Link</Button>
            </a>
          </div>
        </Container>
      ) : (
